...
**Demo:** Exercises 1-4  
**Your turn:** Exercises 5-8 (15 minutes)  
**Notes:** Add any comments/questions that come up during the breakout session at [bit.ly/golive-doc](https://bit.ly/golive-doc).
]
...
.your-turn[
Let's explore Netflix titles! 

- Go to [RStudio Cloud](https://bit.ly/golive-cloud): [bit.ly/golive-cloud](https://bit.ly/golive-cloud).
- Join the workspace (if you haven't yet done so) and click on **Projects** on the top bar.
- Click **START** for the project titled *Netflix titles*.
- Improvise! 
- **Notes:** Take notes on what feels good/right, what is challenging, or any comments/questions that come up during the breakout session at [bit.ly/golive-doc](https://bit.ly/golive-doc).
]
...
## Inspiration: Live coders on YouTube
